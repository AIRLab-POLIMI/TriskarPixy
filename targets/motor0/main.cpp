...
extern "C" {
   ...
   main()
   {
      ...
      pid_node.configuration.measure_topic = "encoder_0";
      pid_node.configuration.output_topic = "pwm_0";
      pid_node.configuration.setpoint_topic = "speed_0";
